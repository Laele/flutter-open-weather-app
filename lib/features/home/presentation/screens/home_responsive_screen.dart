...
import 'package:flutter_weather_app/features/home/presentation/widgets/weather_info_container.dart';
            ...
            if (state is CurrentWeatherSuccess) {
              return Column(
                children: [
                  ...
                  Column(
                    children: [
                      CustomAppBar(location: '${state.weather.city} , ${state.weather.country}'),
