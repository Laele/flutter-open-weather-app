                                              ...
                                              Expanded(
                                                ...
                                                child: FittedBox(
                                                  ...
                                                  child: TweenAnimationBuilder<int>(
                                                    tween: IntTween(begin: 0, end: state.weather.mainTemp.temp.toInt()),
                                                    ...
                                                    builder: (context, value, child) => Text(
                                                      ...
                                                      style: Theme.of(
                                                        context,
                                                      ).textTheme.displayLarge!.copyWith(fontWeight: FontWeight.bold, color: Colors.white),
                                                    ),
                                                ...
                                                Expanded(
                                                  child: FittedBox(
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          'L: ${state.weather.mainTemp.tempMin.toInt()} °C',
                                                          style: Theme.of(
                                                            context,
                                                        ...
                                                        SizedBox(width: 8.0),
                                                        Text(
                                                          'H: ${state.weather.mainTemp.tempMax.toInt()} °C',
                                                          style: Theme.of(
                                                            context,
                                                          ).textTheme.bodyMedium!.copyWith(color: Colors.white, fontWeight: FontWeight.bold),
                                                        ).animate().fade(duration: Duration(seconds: 4)),
                            ...
                            child:
                                Align(
                                      ...
                                      child: Container(
                                        ...
                                        child: LottieBuilder.asset(getWeatherAsset(state.weather.mainWeather.icon)),
